package com.epam.resume.configuration;
...
import com.epam.resume.controller.ProfileController;
import com.epam.resume.filter.ApplicationFilter;
import com.epam.resume.listener.ApplicationListener;
...
public class ResumeWebApplicationInitializer implements WebApplicationInitializer {
	...
	private WebApplicationContext createWebApplicationContext(ServletContext container) {
		...
		ctx.scan("com.epam.resume.configuration");
