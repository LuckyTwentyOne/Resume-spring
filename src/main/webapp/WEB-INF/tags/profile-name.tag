...
<%@ attribute name="profile" required="true" type="com.epam.resume.entity.Profile" %>
<%@ attribute name="showEdit"  required="false" type="java.lang.Boolean" %>

<div class="panel panel-primary">
	<c:choose>
		<c:when test="${showEdit }">
			<a href="/resume/edit"><img alt="photo" src="${profile.largePhoto }" class="img-responsive photo"></a>
